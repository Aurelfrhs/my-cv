  ...
  return (
    <section className='flex flex-col items-center justify-center p-10 min-h-screen w-full' id='about'>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center w-full gap-10'>
        <div className='flex justify-center items-center' data-aos="fade-right" data-aos-offset="500" data-aos-easing="ease-in-sine">
        </div>
        <div className='bg-white text-black p-5 rounded-lg flex items-center justify-center' data-aos="fade-left" data-aos-offset="500" data-aos-easing="ease-in-sine">
